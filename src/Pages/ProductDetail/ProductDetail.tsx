  ...
  return (
    <div className="flex flex-col justify-center items-center gap-y-5 border-[1px] border-[#cfcfcf] pb-[40px] rounded-[20px] pt-[10px] mt-[20px]">
      ...
      <div className="flex justify-center items-center gap-x-5">
        ...
        <Button onClick={()=>handleIncreseProductQty(parseInt(params.id as string))} variant="danger" className="text-xl !p-3">
          افزودن به سبد خرید
        </Button>
        {/* <div>
          <button className="text-4xl text-red-600 ">-</button>
      ...
      <Button variant="secondary" className="text-left w-full">برگشت به صفحه ی قبل</Button>
      </div>
    </div>
  );
};
